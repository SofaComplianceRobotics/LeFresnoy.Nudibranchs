def addHeader(rootnode,
    ...
    settings.addObject('RequiredPlugin', name="external",
                       pluginName=['SoftRobots', 'MultiThreading',
                                   'SoftRobots.Inverse', 'SofaPython3',
                                   ])
    settings.addObject('RequiredPlugin', name="header",
                       pluginName=['Sofa.Component.Collision.Detection.Algorithm',
...
def addSolvers(node, rayleighMass=0., rayleighStiffness=0., firstOrder=False,
